...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/sitio_gol_sv/views/admin/pages/';
    ...
    */
    public function header()
    {
        ...
        $this->image('../../images/fondo_superior_izquierdo.png', 98, -12, 190);

        // Logo
        $this->image('../../images/fondo_superior_derecho.png', 0, 0, 100);

        // Título
        $this->setFont('Arial', 'B', 22);
        $this->Ln(10);
        $this->cell(0, 20, $this->encodeString($this->title), 0, 1, 'R');
        ...
        $this->image('../../images/footer.png', 0, 178, 300, 40);
    }
