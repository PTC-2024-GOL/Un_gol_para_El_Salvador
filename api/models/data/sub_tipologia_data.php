...
require_once('../../models/handler/sub_tipologia_handler.php');
/*
 *  Clase para manejar el encapsulamiento de los datos de la tabla subtipología.
 */
class SubTipologiaData extends SubTipologiaHandler
{
    ...
    // Validación y asignación del ID de la subtipología.
    public function setId($value)
    {
        if (Validator::validateNaturalNumber($value)) {
            ...
            $this->data_error = 'El identificador de la subtipología es incorrecto';
            return false;
        }
    }
