...
const ADMINISTRADOR_API = 'services/technics/tecnicos.php';
...
async function openProfile() {
    ...
    if (DATA.status) {
        ...
        document.getElementById('foto').src = SERVER_URL.concat('images/tecnicos/', DATA.dataset.IMAGEN);
...
const openEdit = async (id) => {
    ...
    try {
        ...
        if (DATA.status) {
            ...
            FOTO_PERFIL.src = SERVER_URL.concat('images/tecnicos/', ROW.IMAGEN);
        } else {
