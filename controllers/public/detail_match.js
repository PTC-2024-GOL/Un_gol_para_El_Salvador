            ...
            DATA.dataset.forEach(row => {
                ...
                const cardHtml = `
                    ...
                    style="
                        ...
                        : row.posicion == "Lateral izquierdo" ? "8%" 
                        : row.posicion == "Defensa central izquierdo" ? "28%" 
                        : row.posicion == "Defensa central derecho" ? "52%" 
                        : row.posicion == "Lateral derecho" ? "75%" 
                        : row.posicion == "Mediocampista" ? mediocentro + "%" 
                        : row.posicion == "Mediocentro defensivo" ? "40%" 
                        : row.posicion == "Mediocentro defensivo izquierdo" ? "28%" 
                        : row.posicion == "Mediocentro defensivo derecho" ? "52%" 
                        : row.posicion == "Mediocentro ofensivo" ? "40%" 
                        : row.posicion == "Interior izquierdo" ? "8%" 
                        : row.posicion == "Interior derecho" ? "75%" 
                        : row.posicion == "Extremo izquierdo" ? "8%" 
                        : row.posicion == "Extremo derecho" ? "75%" 
                        : row.posicion == "Delantero centro" ? "40%" 
                        : row.posicion == "Primer delantero" ? "30%" 
                        : row.posicion == "Segundo delantero" ? "55%" 
                        : row.posicion == "Extremo" ? extremo + "%" 
                        : delantero + "%"}; 
                        left: ${row.posicion == "Portero" ? "6%" 
                        : row.posicion == "Defensa" ? "37%" 
                        : row.posicion == "Central" ? "22%" 
                        : row.posicion == "Lateral izquierdo" ? "25%" 
                        : row.posicion == "Defensa central izquierdo" ? "22%" 
                        : row.posicion == "Defensa central derecho" ? "22%" 
                        : row.posicion == "Lateral derecho" ? "25%" 
                        : row.posicion == "Mediocampista" ? "56%" 
                        : row.posicion == "Mediocentro defensivo" ? "42%" 
                        : row.posicion == "Mediocentro defensivo izquierdo" ? "46%" 
                        : row.posicion == "Mediocentro defensivo derecho" ? "46%" 
                        : row.posicion == "Mediocentro ofensivo" ? "60%" 
                        : row.posicion == "Interior izquierdo" ? "46%" 
                        : row.posicion == "Interior derecho" ? "46%"
                        : row.posicion == "Extremo izquierdo" ? "75%" 
                        : row.posicion == "Extremo derecho" ? "75%"  
                        : row.posicion == "Delantero centro" ? "75%" 
                        : row.posicion == "Primer delantero" ? "75%" 
                        : row.posicion == "Segundo delantero" ? "75%" 
